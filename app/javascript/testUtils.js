 ...
 */
export const STUB_COMPONENT_WARNINGS = /Warning: (<.*> is using incorrect casing|The tag <.*> is unrecognized in this browser|React does not recognize the `.*` prop on a DOM element|Unknown event handler property `.*`. It will be ignored.)/;
