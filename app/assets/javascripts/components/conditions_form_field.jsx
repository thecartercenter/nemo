class ConditionsFormField extends React.Component {
  ...
  getFieldData(ref_qing_id) {
    ...
    //fake data first
    let reference_qing_data = { type: "select", options: [{id: 123, code: "One", rank: 1}, {id: 456, code: "Two", rank: 2}, {id: 789, code: "Three", rank: 3}]}
    ...
    let operator_data = (ref_qing_id == 456) ? { type: "select", options: [{id: "A", name: "Amandla"}, {id: "B", name: "Beyonce"}]} : {type: "select", options: []}
    ...
    let value_data = (ref_qing_id == 456) ? {type: "select", options: [{id: "D", name: "Destiny's Child"}, {id: "S", name: "Sasha Fierce"}, {id: "L", name: "Lemonade"}]} : {type: "select", options: []}
  ...
  render() {
    ...
    let ref_qing_form_field = <FormField name="questioning[condition_attributes][ref_qing_id]" for="questioning_condition_attributes_ref_qing_id" label="Question TO TRANSLATE" type={rq.type} options={this.formatRefQingOptions(rq.options)} id="questioning_condition_attributes_ref_qing_id" key="questioning_condition_attributes_ref_qing_id" changeFunc={this.updateFieldData}/>
