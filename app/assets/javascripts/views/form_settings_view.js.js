 ...
 */
const Cls = (ELMO.Views.FormSettingsView = class FormSettingsView extends ELMO.Views.ApplicationView {
  static initClass() {
  ...
  init_recipient_select() {
    return this.$('#form_recipient_ids').select2({
      ajax: (new ELMO.Utils.Select2OptionBuilder()).ajax(this.recipient_options_url)});
  }
});
Cls.initClass();
