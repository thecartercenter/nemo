...
class ELMO.Views.FormItemsView extends ELMO.Views.ApplicationView
  ...
  events:
    ...
    'click .form-item-group > .inner .action_link_edit': 'show_edit_group_modal'
    'click .form-item-group > .inner .action_link_destroy': 'delete_item'
    'click .form-item-question': 'go_to_question'
    'click .form-item-question > .inner .action_link_destroy': 'delete_item'
  ...
  update_group_action_icons: ->
    for group in @$('.form-item-group')
      link = $(group).find('> .inner .action_link.action_link_destroy')
