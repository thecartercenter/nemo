class QuestionType
  ...
  @@attributes = [
    ...
    { name: 'image', odk_name: 'image/*', properties: %w(multimedia) },
    { name: 'annotated_image', odk_name: 'image/*', properties: %w(multimedia) },
    { name: 'signature', odk_name: 'image/*', properties: %w(multimedia) },
    { name: 'sketch', odk_name: 'image/*', properties: %w(multimedia) },
    { name: 'audio', odk_name: 'audio/*', properties: %w(multimedia) },
    { name: 'video', odk_name: 'video/*', properties: %w(multimedia) },
  ]
