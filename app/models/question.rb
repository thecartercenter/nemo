...
class Question < ApplicationRecord
  ...
  validates_attachment_content_type :audio_prompt, content_type: [%r{\Aaudio/.*\Z}, "video/ogg", "video/webm"]
  validates_attachment_file_name :audio_prompt, matches: /\.(mp3|ogg|webm|wav)\Z/i
