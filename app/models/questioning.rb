class Questioning < ActiveRecord::Base
  ...
  delegate :name, :code, :code=, :level_count, :level, :multi_level?, :option_set, :option_set=, :option_set_id, :option_set_id=, :qtype_name, :qtype_name=, :qtype, :has_options?, :options, :option_path_to_rank_path, :rank_path_to_option_path, :select_options, :odk_code, :odk_constraint, :subquestions, :temporal?, :numeric?, :to => :question
