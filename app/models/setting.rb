class Setting < ActiveRecord::Base
  ...
  KEYS_TO_COPY = %w(timezone preferred_locales intellisms_username intellisms_password incoming_sms_number twilio_account_sid twilio_auth_token)
  ...
  attr_accessor :intellisms_password1, :intellisms_password2, :twilio_auth_token1, :twilio_auth_token2
  ...
  private
    ...
    def sms_credentials_are_valid
      ...
      when "Twilio"
        ...
        errors.add(:twilio_auth_token1, :did_not_match) unless twilio_auth_token1 == twilio_auth_token2
      else
