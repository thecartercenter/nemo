...
class Response < ActiveRecord::Base
  ...
  attr_accessor(:modifier, :dup_resp, :excerpts)
  ...
  def self.search_qualifiers(scope)
    [
      ...
      Search::Qualifier.new(:name => "signature", :col => "responses.signature"),
      Search::Qualifier.new(:name => "duplicate", :col => "responses.duplicate", :subst => {"yes" => "1", "no" => "0"}),
