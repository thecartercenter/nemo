...
class FormTemplatesController < ApplicationController
  ...
  before_action :set_form_template, only: [:show, :edit, :update, :destroy, :use]
  ...
  def create_from_template
    ...
    begin
      ...
      redirect_to form_path(form), notice: "Form '#{form.name}' created successfully from template '#{@form_template.name}'."
    rescue => e
