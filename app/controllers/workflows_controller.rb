...
class WorkflowsController < ApplicationController
  ...
  before_action :set_workflow, only: %i[show edit update destroy activate deactivate]
  ...
  def create_instance
    ...
    render(json: {success: false, error: "Invalid trigger_object_type"}, status: :bad_request) and return unless klass
  ...
  def workflow_params
    params.require(:workflow).permit(
      ...
      config: %i[setting_a setting_b] # TODO: replace with actual valid config keys
    )
  end
end
