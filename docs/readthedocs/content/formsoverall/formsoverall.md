...
![Form flowchart](Form-flowchart-e1460060337288.png)
...
The **_Forms_** menu lists all the available forms for a mission. These are the components:![forms tab edited](forms-tab-edited.png)

![forms tab edited inset](forms-tab-edited-inset.png)
...
![Group Example](Group-Example.jpg)
...
2.  Groups cannot be made conditional or hold both [conditional questions](../formsquestions/formsquestions.html) and the questions that trigger them.

To create a form with groups:

![To create a group instructions edited](To-create-a-group-instructions-edited.png)
...
![Screenshot_2016-03-15-10-23-18](Screenshot_2016-03-15-10-23-18.png)
...
5.  Click **_Save_**  
    ![create standard form edited](create-standard-form-edited.png)
6.  Click **_Add Questions_** to add questions to the form
7.  Click **_Add Groups_** to add groups to the form
8.  Click **_Save_**  
    ![standard form add questions edited](standard-form-add-questions-edited-1.png)
...
![publish forms edited](publish-forms-edited.png)
...
3.  Click **_Print Form_** (shown below)  
    ![print form icon](print-form-icon.png)
