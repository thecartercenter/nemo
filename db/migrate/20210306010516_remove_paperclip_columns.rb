...
class RemovePaperclipColumns < ActiveRecord::Migration[6.1]
  ...
  def remove_paperclip_metadata
    ...
    remove_column :operations, :attachment_legacy_url, :string if ActiveRecord::Base.connection.column_exists?(
      :operations, :attachment_legacy_url
    )
    ...
    remove_column :saved_uploads, :file_legacy_url, :string if ActiveRecord::Base.connection.column_exists?(
      :saved_uploads, :file_legacy_url
    )
    ...
    remove_column :questions, :media_prompt_legacy_url, :string if ActiveRecord::Base.connection.column_exists?(
      :questions, :media_prompt_legacy_url
    )
    ...
    remove_column :media_objects, :item_legacy_url, :string if ActiveRecord::Base.connection.column_exists?(
      :media_objects, :item_legacy_url
    )
    ...
    remove_column :responses, :odk_xml_legacy_url, :string if ActiveRecord::Base.connection.column_exists?(:responses,
      :odk_xml_legacy_url)
