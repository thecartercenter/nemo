class Condition < ActiveRecord::Base
  belongs_to(:ref_qing, class_name: "Questioning", inverse_of: :referring_conditions)
  ...
  def option_nodes
    if option_ids.nil?
      ...
      OptionNode.where(option_id: option_ids, option_set_id: ref_qing.option_set).sort_by do |on|
        option_ids.index(on.option_id)
      end
    end
  end
end
  ...
  def up
    ...
    transaction do
      ...
      Condition.all.each do |condition|
        next unless condition.option_ids.present?
