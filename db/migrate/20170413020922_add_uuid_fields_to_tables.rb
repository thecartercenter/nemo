...
class AddUuidFieldsToTables < ActiveRecord::Migration[4.2]
  TABLES_FOR_MIGRATION = %i[answers assignments broadcast_addressings broadcasts choices conditions
                            ...
                            user_group_assignments user_groups users whitelistings].freeze
