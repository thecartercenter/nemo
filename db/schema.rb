...
ActiveRecord::Schema.define(version: 2020_03_23_001444) do
  ...
  add_foreign_key "broadcast_addressings", "broadcasts"
  add_foreign_key "broadcasts", "missions"
  ...
  add_foreign_key "sms_messages", "missions"
  ...
  add_foreign_key "users", "missions", column: "last_mission_id", on_delete: :nullify
  add_foreign_key "whitelistings", "users"
