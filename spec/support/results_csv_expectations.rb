...
Sample Form 1,A User 3,2015-11-20 06:40 CST,#{uuids[2]},#{shortcodes[2]},foo,Canada,,,,bar,100,-123.5,15.937378,44.36453,Cat,Dog,Cat,Dog;Cat,2015-10-12 12:15 CST,2014-11-09,23:15\r
Sample Form 1,A User 4,2015-11-20 06:45 CST,#{uuids[3]},#{shortcodes[3]},foo,Ghana,,7.1,0.4,bar,100,-123.5,15.937378,44.36453,Cat,Dog,Cat,Dog;Cat,2015-10-12 12:15 CST,2014-11-09,23:15\r
...
Sample Form 1,A User 2,2015-11-20 06:40 CST,#{uuids[1]},#{shortcodes[1]},,0,3,,,,4,,,,,,\r
Sample Form 1,A User 2,2015-11-20 06:40 CST,#{uuids[1]},#{shortcodes[1]},Fruit,1,3,Xigua,10,Dog,4,,,,,,\r
Sample Form 1,A User 2,2015-11-20 06:40 CST,#{uuids[1]},#{shortcodes[1]},Fruit,1,3,Yuzu,9,Cat;Dog,4,,,,,,\r
Sample Form 1,A User 2,2015-11-20 06:40 CST,#{uuids[1]},#{shortcodes[1]},Fruit,1,3,Ugli,8,Cat,4,,,,,,\r
Sample Form 1,A User 2,2015-11-20 06:40 CST,#{uuids[1]},#{shortcodes[1]},Vegetable,1,3,,,,4,Zucchini,Canada,Calgary,51.045,-114.057222,7\r
Sample Form 1,A User 2,2015-11-20 06:40 CST,#{uuids[1]},#{shortcodes[1]},Vegetable,1,3,,,,4,Yam,Canada,Ottawa,45.429299,-75.629883,6\r\n")
  end
end
