...
describe Report::ResponseTallyReport do
  ...
  context "with multilevel option set" do
    before do
      ...
      create(:response, form: @form, answer_values: [%w[Animal Cat]], source: "web")
      create(:response, form: @form, answer_values: [%w[Animal Dog]], source: "web")
      create(:response, form: @form, answer_values: [["Animal"]], source: "odk")
      create(:response, form: @form, answer_values: [%w[Plant Oak]], source: "odk")
