...
describe "geopoint processing" do
  ...
  context "with normal lat/lng values" do
    ...
    it "should process properly" do
      expect_location_answer(response, answer, val: value, lat: -2.366030, lng: -0.039825, alt: nil, acc: nil)
    end
  ...
  context "with normal values but extra precision" do
    ...
    it "should process properly" do
      expect_location_answer(response, answer, val: "-2.366031 -0.039826 100.235 20.000",
  ...
  context "with invalid altitude" do
    ...
    it "should process properly" do
      expect_location_answer(response, answer, val: "-4.366030 -22.039825 0.000",
  ...
  context "with negative accuracy" do
    ...
    it "should process properly" do
      expect_location_answer(response, answer, val: "-4.366030 -22.039825 33.900 0.000",
  ...
  context "with extra value" do
    ...
    it "should process properly" do
      expect_location_answer(response, answer, val: "-2.366030 -0.039825 100.235 20.000",
                                     lat: -2.366030, lng: -0.039825, alt: 100.235, acc: 20.0)
    end
  ...
  context "updating with less data" do
    ...
    it "should update properly" do
      ...
      expect_location_answer(response, answer, val: "12.340000 56.780000",
