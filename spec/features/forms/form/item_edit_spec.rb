...
feature "forms", js: true do
  ...
  context "with groups and conditions" do
    ...
    before do
      form.c[1].display_conditions.create!(left_qing: form.c[0], op: "gt", value: "5")
      form.c[2].display_conditions.create!(left_qing: form.c[0], op: "gt", value: "6")
    end
    ...
    scenario "editing several group conditions successively" do
      ...
      click_form_item_action_icon([1], :edit)
      within(".modal") do
        expect(page).to have_css(".condition-value input[value=15]")
        find(".btn-primary").click
      end
      ...
      click_form_item_action_icon([2], :edit)
      within(".modal") do
        expect(page).to have_css(".condition-value input[value=16]")
      end
    end
  end
