ELMO::Application.routes.draw do
  ...
  scope ":locale/:mode(/:mission_name)", locale: /[a-z]{2}/, mode: /m|admin/, mission_name: /[a-z][a-z0-9]*/ do
    ...
    resources :forms, constraints: lambda { |req| req.format == :html } do
      member do
  ...
  scope "(/:locale)/m/:mission_name", mission_name: /[a-z][a-z0-9]*/, defaults: { mode: "m", direct_auth: "basic" }, constraints: lambda { |req| req.format == :xml || req.format == :csv } do
