...
CONTAINER_NAME = ENV.fetch("NEMO_AZURE_ARCHIVE_CONTAINER", nil)
AZURE_NAME = ENV.fetch("NEMO_AZURE_ARCHIVE_ACCOUNT_NAME", nil)
AZURE_KEY = ENV.fetch("NEMO_AZURE_ARCHIVE_ACCESS_KEY", nil)
