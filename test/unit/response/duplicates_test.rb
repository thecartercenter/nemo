...
class Response::DuplicatesTest < ActiveSupport::TestCase
  ...
  test "responses using choices for answers" do
    ...
    response1 = FactoryGirl.create(:response, :form => @form1, :answer_names => { :q1 => "No", :q2 => "Yes", :q3 => "value1" , :q4 => ["Yes","No"]})
    
    # create a response with a different options for select_multiple question
    response2 = FactoryGirl.create(:response, :form => @form1, :answer_names => { :q1 => "No", :q2 => "Yes", :q3 => "value1" , :q4 => ["No","No"]})
  ...
  test "responses using text values for answers" do
    ...
    response2 = FactoryGirl.create(:response, :form => @form1, :answer_names => { :q1 => "No", :q2 => "Yes", :q3 => "different value" , :q4 => ["Yes","No"]})
